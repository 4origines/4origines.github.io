# originebrass.com source code

Using the [mandrasch/11ty-plain-bootstrap5: Plain template for static site generator Eleventy with Boostrap5 and laravel-mix.](https://github.com/mandrasch/11ty-plain-bootstrap5) starter template.
...
`git clone https://github.com/$githubUsername/4origines.github.io.git`
...
`cd 4origines.github.io/`

4. Add a reference to the upstream.

`git remote add upstream https://github.com/4origines/4origines.github.io.git`
...
After cloning and installing project Node.js modules, type `npm run dev` into your command line application. This will tell Node.js to compile the project and turn it into a website.
